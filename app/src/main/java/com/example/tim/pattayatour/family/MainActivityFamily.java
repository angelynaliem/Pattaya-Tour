...
public class MainActivityFamily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPager viewPager = findViewById(R.id.family_viewpager);

        // Create an adapter that knows which fragment should be shown on each page
        PagerAdapter adapter = new FamilyPageAdapter(this, getSupportFragmentManager());

        // Set the adapter onto the view pager
        viewPager.setAdapter(adapter);

        // Find the tab layout that shows the tabs
        TabLayout tabLayout = findViewById(R.id.family_sliding_tabs);
